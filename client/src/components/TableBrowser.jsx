      ...
      <div className="page-title">
        ...
        {table && (
          <div className="page-actions">
            <button className="primary" disabled={loading} onClick={openAdd}>
              + New Row
            </button>
            <button
      ...
      {table && (
        <>
          <div className="data-toolbar">
            ...
            <button className="primary" onClick={performSearch}>
              Search
            </button>
            ...
            {schema.map((column) => (
              <div className="column-filter" key={column.name}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, [column.name]: e.target.value })
                  }
                  onKeyDown={(e) => {
                    if (e.key === "Enter") performSearch();
                  }}
        ...
        <>
          <div className="table-container">
            <div
              ...
              tabIndex={0}
              role="region"
              aria-label="Table records, scroll to view more columns"
            >
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  {rows.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={schema.length + 1} className="no-data">
                        No records found.
                      </td>
                    </tr>
                  )}
